...
const formData = ref<PortfolioInput>({
  name: '',
  description: '',
  initialCapital: 10000000, // Default 10 juta IDR
  baseCurrency: 'IDR',
  marketType: 'IDX',
})
...
const handleSubmit = async () => {
  ...
  try {
    const portfolioId = await portfoliosStore.createPortfolio(formData.value)
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                class="w-full border-[3px] border-black p-3 font-mono focus:outline-none focus:ring-4 focus:ring-[#f59e0b] transition-all bg-white"
            ...
            <div class="bg-[#fef3c7] border-[3px] border-black p-4">
              <div class="flex gap-3">
                ...
                <p class="text-sm text-[#0a0a0a] font-mono">
                  Portfolio akan digunakan untuk mencatat trades dan menganalisis performa trading Anda.
                  Modal awal ini akan menjadi baseline untuk perhitungan return.
                </p>
              </div>
            </div>
          </form>
