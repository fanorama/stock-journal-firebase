...
const handleDelete = async () => {
  if (!props.portfolio) {
    deleteError.value = 'Portfolio tidak ditemukan'
    return
  }
        ...
        <div class="p-6 space-y-4">
          ...
          <div class="space-y-3">
            <p class="text-[#0a0a0a] font-mono text-sm">
              Anda yakin ingin menghapus portfolio berikut?
            </p>
            ...
            <div class="bg-[#fee2e2] border-[3px] border-black p-4">
              <div class="flex gap-3">
                ...
                <div class="text-sm text-[#0a0a0a] font-mono space-y-1">
                  ...
                  <p>
                    Menghapus portfolio akan menghapus <strong>semua data trades dan journal entries</strong> yang terkait dengan portfolio ini.
                  </p>
        ...
        <div class="bg-[#fafafa] border-t-[5px] border-black p-6">
          <div class="flex gap-4 justify-end">
            ...
            >
              ...
              {{ isDeleting ? 'Menghapus...' : 'Ya, Hapus Portfolio' }}
            </button>
          </div>
        </div>
      </div>
