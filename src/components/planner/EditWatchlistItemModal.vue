...
const emit = defineEmits<{
  close: []
  success: [updates: Partial<WatchlistItem>]
}>()
...
/**
 * Watch show prop to populate form with item data
 */
watch(
  () => props.show,
  (newShow) => {
...
const populateForm = () => {
  formData.value = {
    ...
    targetEntry: props.item.targetEntry,
    targetExit: props.item.targetExit,
  }
  showStrategyPreview.value = !!props.item.strategyId
}
