...
<template>
  <Teleport to="body">
    ...
    >
      <div
        class="bg-white border-[5px] border-black p-6 max-w-md w-full shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]"
      >
        <!-- Modal Header -->
        <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <select
            ...
            class="w-full border-[3px] border-black p-3 font-mono text-sm text-[#0a0a0a] focus:outline-none focus:ring-4 focus:ring-[#3b82f6] transition-all bg-white"
          >
        ...
        <div class="mb-6">
          ...
          <textarea
            ...
            class="w-full border-[3px] border-black p-3 font-mono text-sm text-[#0a0a0a] placeholder:text-[#a3a3a3] focus:outline-none focus:ring-4 focus:ring-[#3b82f6] transition-all resize-none"
            maxlength="300"
          ></textarea>
